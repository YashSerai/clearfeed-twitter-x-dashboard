...
if ($providerChoice -eq "1") {
    ...
    Set-EnvValue -Path ".\\.env" -Key "AI_VOICE_REVIEW_MODEL" -Value ""
    Set-EnvValue -Path ".\\.env" -Key "AI_ARCHIVE_VOICE_MODEL" -Value ""
    ...
    Set-EnvValue -Path ".\\.env" -Key "VOICE_REVIEW_MODE" -Value "scheduled"
    Set-EnvValue -Path ".\\.env" -Key "VOICE_REVIEW_CADENCE" -Value "daily"
    $providerSummary = @(
